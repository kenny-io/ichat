...
//public class RegisterationInteractor {
//}
...
public class RegisterationInteractor implements RegisterationContract.Interactor {
    private static final String TAG = RegisterationInteractor.class.getSimpleName();

    private RegisterationContract.OnRegistrationListener mOnRegistrationListener;

    public RegisterationInteractor(RegisterationContract.OnRegistrationListener onRegistrationListener) {
