package com.example.ekene.ichat.ui.fragments;
...
import com.example.ekene.ichat.core.Registeration.RegisterationContract;
import com.example.ekene.ichat.core.Registeration.RegisterationPresenter;
import com.example.ekene.ichat.core.Users.Add.AddUserContract;
import com.example.ekene.ichat.core.Users.Add.AddUserPresenter;
import com.example.ekene.ichat.ui.activities.UserListingActivity;
import com.google.firebase.auth.FirebaseUser;



public class RegisterFragment extends Fragment implements View.OnClickListener, RegisterationContract.View, AddUserContract.View {
    private static final String TAG = RegisterFragment.class.getSimpleName();

    private RegisterationPresenter mRegisterPresenter;
    ...
    private void bindViews(View view) {
        ...
        mETxtPassword = (EditText) view.findViewById(R.id.edit_text_password_id);
    ...
    private void init() {
        mRegisterPresenter = new RegisterationPresenter(this);
